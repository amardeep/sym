...
private:
	...
	bool m_view_kmin;
	bool m_view_kmax;
	bool m_view_asymptotic_directions;
...
public:
	...
	afx_msg void OnViewKmin();
	afx_msg void OnUpdateViewKmin(CCmdUI *pCmdUI);
	afx_msg void OnViewKmax();
	afx_msg void OnUpdateViewKmax(CCmdUI *pCmdUI);
	afx_msg void OnViewAsymptotic();
	afx_msg void OnUpdateViewAsymptotic(CCmdUI *pCmdUI);
};
